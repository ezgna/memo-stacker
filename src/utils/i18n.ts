...
const i18n = new I18n({
  en: {
    ...
    device_transfer_answer: "Supported only on iOS.\nExport your data from the settings page (signup required). Google Drive is used, so a Google account is necessary. After exporting, ensure the file is saved in Google Drive, then import it on your new device.",
