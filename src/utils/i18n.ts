...
const i18n = new I18n({
  en: {
    ...
    purchase_already_owned: "You already own this. Please restore your purchase.",
    purchase_error: "We couldn’t complete your purchase. Please try again in a moment. If this keeps happening, contact support.",
  ...
  ja: {
    ...
    purchase_error_already_owned: "すでに購入済みです。「購入の復元」を実行してください。",
    purchase_error: "購入を完了できませんでした。しばらくしてから再試行してください。解決しない場合はサポートへご連絡ください。",
